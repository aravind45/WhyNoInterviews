...
async function testEnhancedFeedback() {
  ...
  try {
    ...
    const mockFeedback = {
      ...
      rubrics: {
        activeListening: {
          ...
          maxScore: 5,
          feedback:
            'You demonstrated some good active listening skills, particularly when you asked for clarification about specific requirements.',
          improvements:
            "To improve your active listening, try to acknowledge and build on your conversation partner's comments more often.",
          showInsights: true,
        },
        keyAccomplishments: {
          score: 4,
          maxScore: 5,
          feedback:
            'You did well in sharing key accomplishments that demonstrate your impact through structured storytelling.',
        ...
        communication: {
          ...
          improvements:
            'Work on reducing filler words and varying your vocal tone to project more confidence.',
          showInsights: true,
        },
        technicalKnowledge: {
          score: 4,
      ...
      detailedFeedback: [
        {
          ...
          feedback:
            'Good job on expressing gratitude for the opportunity. Consider elaborating slightly on your motivations.',
          tone: {
            professional: 85,
            clear: 80,
            relaxed: 75,
          ...
          conciseness: {
            timestamp: '2:15',
            originalText:
              "So, um, I've been working in software development for, uh, about five years now and I really enjoy, you know, solving complex problems...",
            improvedText:
              "I've been in software development for five years, focusing on solving complex technical challenges.",
            explanation:
              'This revision removes filler words and redundancy while maintaining the key message.',
          },
        },
      ],
      summary: [
    ...
    console.log(
      `   🗣️  Pronunciation: ${mockFeedback.pronunciation.syllableStress.length + mockFeedback.pronunciation.consonantClusters.length} tips`,
    );
    ...
    Object.entries(mockFeedback.rubrics).forEach(([key, rubric]) => {
      ...
      console.log(
        `   ${isValidScore && hasRequiredFields ? '✅' : '❌'} ${key}: ${rubric.score}/5 ${isValidScore && hasRequiredFields ? '(Valid)' : '(Invalid)'}`,
      );
    });
