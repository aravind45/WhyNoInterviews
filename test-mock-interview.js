...
async function testMockInterview() {
    ...
    try {
        ...
        const questionsResponse = await fetch(`${BASE_URL}/api/mock-interview/generate-interview-questions`, {
            method: 'POST',
        ...
        if (sessionResponse.ok) {
            ...
            const uploadResponse = await fetch(`${BASE_URL}/api/mock-interview/upload-interview-response`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
            ...
            if (uploadResponse.ok) {
                ...
                const resultsResponse = await fetch(`${BASE_URL}/api/mock-interview/interview-results/${sessionData.data.sessionToken}`);
