...
const client = new Client({
  connectionString:
    'postgresql://neondb_owner:npg_U1ZDnWkKoIj9@ep-quiet-heart-ahc56mo8-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require',
...
async function test() {
  try {
    ...
    const companies = await client.query(
      'SELECT company_name, industry FROM global_company_suggestions ORDER BY company_name',
    );
