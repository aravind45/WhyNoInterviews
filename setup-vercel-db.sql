-- Connect to the exact database that Vercel uses
-- Database: postgresql://neondb_owner:***@ep-quiet-heart-ahc56mo8-pooler.c-3.us-east-1.aws.neon.tech/neondb
...
-- Contact Import Batches table (THIS IS THE MISSING TABLE!)
...
WHERE schemaname = 'public'
  AND tablename IN ('user_sessions', 'resume_analyses', 'linkedin_contacts', 'contact_import_batches', 'contact_interactions')
ORDER BY tablename;
