...
COMMENT ON COLUMN diagnosis_results.model_used IS 'Specific model name (e.g., llama-3.1-8b-instant, claude-sonnet-4-5-20250929)';
COMMENT ON COLUMN diagnosis_results.llm_provider IS 'LLM provider used (groq or claude)';
COMMENT ON COLUMN resume_analyses.llm_provider IS 'LLM provider requested for analysis (groq or claude)';
